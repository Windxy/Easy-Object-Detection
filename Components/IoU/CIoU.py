...
def DIoU(box1,box2):
    ...
    w1,h1,w2,h2 = box1[3] - box1[1],box1[2]-box1[0],box2[3] - box2[1],box2[2]-box1[0],

    w_h_radio = 4 / math.pi * math.pow((math.atan(w1/h1) -math.atan(w2/h2)),2)
    a = 1.   # 超参数α
    diou = iou - distance_radio - w_h_radio * a
    return diou